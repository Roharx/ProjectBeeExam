      ...
      <div id="interface">
        ...
        <div id="interface-middle">
          ...
          <input type="password" class="text-bar" id="password-bar" [formControl]="updateForm.controls.password"
                 [ngClass]="{'red-border': isInvalidPassword()}">
          <div *ngIf="isInvalidPassword()" style="color: var(--red-color);">
          ...
          <input type="password" class="text-bar" id="password-repeat-bar"
                 ...
                 [ngClass]="{'red-border': isInvalidRepeatPassword()}">
          <div *ngIf="isInvalidRepeatPassword()" style="color: var(--red-color);">
...
export class UserComponent implements OnInit {
  ...
  isInvalidPassword(): boolean {
    return this.updateForm.controls.password.invalid && this.updateForm.controls.password.touched;
  }

  isInvalidRepeatPassword(): boolean {
    return this.updateForm.controls.repeatPassword.touched &&
      this.updateForm.controls.repeatPassword.value !== this.updateForm.controls.password.value;
  }
